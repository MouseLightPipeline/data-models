...
var Fluorophore;
(function (Fluorophore_1) {
    Fluorophore_1.ModelName = "Fluorophore";
    function sequelizeImport(sequelize, DataTypes) {
        const Fluorophore = sequelize.define(Fluorophore_1.ModelName, {
            id: {
                primaryKey: true,
                type: DataTypes.UUID,
    ...
    Fluorophore_1.sequelizeImport = sequelizeImport;
})(Fluorophore = exports.Fluorophore || (exports.Fluorophore = {}));
