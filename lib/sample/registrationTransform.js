...
class RegistrationTransformModelDefinition {
    constructor() {
        this._modelName = ModelName;
    }
    get modelName() { return this._modelName; }
    sequelizeImport(sequelize, DataTypes) {
        const RegistrationTransform = sequelize.define(ModelName, {
            id: {
                primaryKey: true,
                type: DataTypes.UUID,
...
exports.RegistrationTransform = new RegistrationTransformModelDefinition();
