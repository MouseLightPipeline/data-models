...
var MouseStrain;
(function (MouseStrain_1) {
    MouseStrain_1.ModelName = "MouseStrain";
    function sequelizeImport(sequelize, DataTypes) {
        const MouseStrain = sequelize.define(MouseStrain_1.ModelName, {
            id: {
                primaryKey: true,
                type: DataTypes.UUID,
    ...
    MouseStrain_1.sequelizeImport = sequelizeImport;
})(MouseStrain = exports.MouseStrain || (exports.MouseStrain = {}));
